        ...
        #try:
            ...
            if backup:
                try:
                    ...
                    # salvo le modifiche
                    db_file = open(database_backup_file_name, "w")
                    ...
                    check_file = open(check_backup_file_name, "w")
                    check_file.write(json.dumps(check_file_content))
                    check_file.close()
            ...
            for game in games:
                ...
                self.add_to_tree(self.__get_game_handle(game), db_file_content, verbose=verbose)
